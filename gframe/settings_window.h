...
struct SettingsWindow {
  ...
  struct SettingsTab {
    irr::gui::IGUITab *tab{};
    irr::gui::Panel *panel{};
    void construct(irr::gui::IGUIEnvironment *env,
                   irr::gui::CGUIWindowedTabControl *tabControl,
                   const wchar_t *name);
  };
  SettingsTab client;
  ...
  SettingsTab cardPlus;
  irr::gui::IGUICheckBox *chkModularRenderer;
  irr::gui::IGUICheckBox *chkHighResArt;
